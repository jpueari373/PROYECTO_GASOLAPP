...
public class EliminarFavoritosAdmin extends AppCompatActivity {
    private ArrayAdapter<String> adaptador; //Adaptador controlador de datos
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.eliminar_favoritos);
        Button buscar = findViewById(R.id.boton_buscar_usuario);
        buscar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText username = findViewById(R.id.eliminarFavoritos_usuario);
    ...
    //Este metodo realiza una consulta a la bd, mediante un fichero php, donde se le pasa el nombre del usuario y carga la lista de favoritos del usuario
                    ...
                    public void onResponse(String response) {//Este metodo obtinene el resultado de la consulta en JSON
                        ...
                        try {
                            ...
                            if (jsonArray.length() == 0) {
                                Toast.makeText(EliminarFavoritosAdmin.this, "No se encontraron gasolineras en favoritos de este usuario", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            e.printStackTrace();
                            Toast.makeText(EliminarFavoritosAdmin.this, "Este usuario no tiene favoritos", Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EliminarFavoritosAdmin.this, "Error: " + error.toString(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
    ...
    private void cargarLista(ArrayList<Gasolineras> gasolineras) {
        ...
        ListView listaView = findViewById(R.id.lista_favoritos_eliminar);
        ...
        listaView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(EliminarFavoritosAdmin.this);
                builder.setMessage("Rótulo: " + rotulo + "\n SP95: " + sp95 + " l/€\n SP98: " + sp98 + " l/€\n A: " + a + " l/€\n A+: " + aPlus + " l/€\n B: " + b + " l/€\n Horario: " + horario)
                        .setPositiveButton("Eliminar Favoritos", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        try {
                                            ...
                                            if (res == true){
                                                ...
                                                android.app.AlertDialog.Builder alerta = new android.app.AlertDialog.Builder(EliminarFavoritosAdmin.this);
                                ...
                                Toast.makeText(EliminarFavoritosAdmin.this, "Eliminada de favoritos", Toast.LENGTH_SHORT).show();
                                EliminarFavoritosRequest efr = new EliminarFavoritosRequest(field1, respuesta);
                                RequestQueue cola = Volley.newRequestQueue(EliminarFavoritosAdmin.this);
                                cola.add(efr);//añade a la cola la request anterior
                                recreate();//Reinicia la activity actual
                            }
...
//Obtener del array las direciones de las gasolineras para mostrarlas en la lista
